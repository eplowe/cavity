namespace Cavity.Data
{
    ...
    public sealed class RepositoryUpdateRecordStatusNull<T> : IVerifyRepository<T>
    {
        public RepositoryUpdateRecordStatusNull()
        {
        ...
        public void Verify(IRepository<T> repository)
        {
            ...
            using (new TransactionScope())
            {
                ...
                {
                    throw new UnitTestException(Resources.Repository_Update_RecordStatusNull_UnitTestExceptionMessage, exception);
                }

                if (null == expected)
                {
                    throw new UnitTestException(Resources.Repository_Update_RecordStatusNull_UnitTestExceptionMessage);
                }
            }
        }
    }
