namespace Cavity.Data
{
    ...
    public sealed class RepositoryExistsUrnNotFoundOfTFacts
    {
        ...
        public void op_Verify_IRepository()
        {
            ...
            new RepositoryExistsUrnNotFound<int>().Verify(repository.Object);
        ...
        public void op_Verify_IRepository_whenTrue()
        {
            ...
            Assert.Throws<UnitTestException>(() => new RepositoryExistsUrnNotFound<int>().Verify(repository.Object));
