namespace Cavity.Data
{
    ...
    public sealed class RepositoryUpsertRecordNullOfTFacts
    {
        ...
        public void op_Verify_IRepository()
        {
            ...
            new RepositoryUpsertRecordNull<int>().Verify(repository.Object);
        ...
        public void op_Verify_IRepository_whenExceptionIsNotThrown()
        {
            ...
            Assert.Throws<UnitTestException>(() => new RepositoryUpsertRecordNull<int>().Verify(repository.Object));
