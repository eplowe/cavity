    ...
    public class TsvStreamReader : StreamReader
    {
            ...
            where T : KeyStringDictionary, new()
        {
            ...
            if (0 != entry.Count)
            {
                ...
                {
#if NET20
                    throw new FormatException(StringExtensionMethods.FormatWith(Resources.TsvStreamReader_ReadEntry_FormatException, LineNumber));
#else
                    throw new FormatException(Resources.TsvStreamReader_ReadEntry_FormatException.FormatWith(LineNumber));
#endif
                }
