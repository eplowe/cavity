namespace Cavity.Data
{
    ...
    public sealed class RepositoryDeleteUrnNullOfTFacts
    {
        ...
        public void op_Verify_IRepository()
        {
            ...
            new RepositoryDeleteUrnNull<RandomObject>().Verify(repository.Object);
        ...
        public void op_Verify_IRepository_whenExceptionIsNotThrown()
        {
            ...
            Assert.Throws<RepositoryTestException>(() => new RepositoryDeleteUrnNull<RandomObject>().Verify(repository.Object));
