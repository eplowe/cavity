namespace Cavity.Data
{
    ...
    public sealed class RepositoryUpdateRecordKeyNullOfTFacts
    {
        [Fact]
        public void a_definition()
        {
            Assert.True(new TypeExpectations<RepositoryUpdateRecordKeyNull<int>>()
        ...
        public void ctor()
        {
            Assert.NotNull(new RepositoryUpdateRecordKeyNull<int>());
        }
        ...
        {
            var obj = new RepositoryUpdateRecordKeyNull<RandomObject>();
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new RepositoryUpdateRecordKeyNull<int>().Verify(null));
        }
