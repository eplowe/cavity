namespace Cavity.Data
{
    ...
    public sealed class RepositoryModifiedSinceUrnNullOfTFacts
    {
        ...
        public void op_Verify_IRepository()
        {
            ...
            new RepositoryModifiedSinceUrnNull<int>().Verify(repository.Object);
        ...
        public void op_Verify_IRepository_whenExceptionIsNotThrown()
        {
            ...
            Assert.Throws<UnitTestException>(() => new RepositoryModifiedSinceUrnNull<int>().Verify(repository.Object));
