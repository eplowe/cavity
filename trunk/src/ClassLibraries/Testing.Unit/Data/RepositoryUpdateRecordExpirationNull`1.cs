namespace Cavity.Data
{
    ...
    public sealed class RepositoryUpdateRecordExpirationNull<T> : IVerifyRepository<T>
    {
        public RepositoryUpdateRecordExpirationNull()
        {
        ...
        public void Verify(IRepository<T> repository)
        {
            ...
            using (new TransactionScope())
            {
                ...
                if (null == expected)
                {
                    throw new UnitTestException(Resources.Repository_Update_RecordExpirationNull_UnitTestExceptionMessage);
                }
            }
        }
    }
