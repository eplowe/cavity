namespace Cavity.Data
{
    ...
    public sealed class RepositoryUpdateRecordKeyNull<T> : IVerifyRepository<T>
    {
        public RepositoryUpdateRecordKeyNull()
        {
        ...
        public void Verify(IRepository<T> repository)
        {
            ...
            using (new TransactionScope())
            {
                ...
                {
                    throw new UnitTestException(Resources.Repository_Update_RecordKeyNull_UnitTestExceptionMessage, exception);
                }
